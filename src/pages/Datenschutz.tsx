        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              ...
              mein Aufstellungsarbeitsangebot ansprechend und barrierearm zu präsentieren. Rechtsgrundlage für die
            ...
            <p>
              ...
              Interesse an einer qualitativen Verbesserung meines Aufstellungsarbeitsangebots (Art. 6 Abs. 1 lit. f DSGVO).
            </p>
            <p>
            ...
            <p>
              ...
              heilkundliche Behandlung oder ärztliche Aufstellungsarbeit.
            </p>
          </div>
        </div>
      </main>
