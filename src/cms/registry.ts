...
export const cmsRegistry: CMSEntry[] = [
  ...
  { key: "contact.headline", type: "text", category: "Kontakt", label: "Kontakt Hauptüberschrift" },
  { key: "contact.altTitle", type: "text", category: "Kontakt", label: "Alternativer Titel" },
