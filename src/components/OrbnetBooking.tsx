...
const OrbnetDialog = ({ semuid, open, onClose }: OrbnetDialogProps) => {
  ...
  return (
    ...
    >
      <div className="relative bg-background rounded-lg shadow-[var(--shadow-elevated)] w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
...
const OrbnetIframeDialog = ({ url, open, onClose }: OrbnetIframeDialogProps) => {
  ...
  return (
    <div
      ...
      onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}
    >
      <div className="relative bg-background rounded-lg shadow-[var(--shadow-elevated)] w-full max-w-2xl h-[90vh] flex flex-col">
    ...
    <>
      <div className="fixed bottom-[18px] right-20 z-50">
        <Button
          ...
          size="lg"
          className="rounded-full shadow-[var(--shadow-soft)] min-h-[56px] min-w-[56px] p-4 md:px-6 md:py-3"
