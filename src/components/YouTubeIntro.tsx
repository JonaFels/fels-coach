...
export const YouTubeIntro = ({ videoId, title, subtitle }: YouTubeIntroProps) => {
  ...
  const sub =
    subtitle ??
    (language === "de"
      ? "In knapp drei Minuten erfährst du, wer ich bin, wie ich arbeite und für wen meine Aufstellungsarbeit gedacht ist."
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative aspect-video rounded-lg overflow-hidden shadow-[var(--shadow-soft)] ring-1 ring-border/20 bg-muted">
            {activated ? (
              <iframe
