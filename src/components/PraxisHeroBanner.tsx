...
export const PraxisHeroBanner = ({ variant = "sitzbereich" }: PraxisHeroBannerProps) => {
  ...
  const alt =
    variant === "lounge"
      ? "Aufstellungsarbeitspraxis von Jona Fels in Freiburg – gemütlicher Lounge-Bereich mit Rattanstuhl und Glastisch"
      : "Aufstellungsarbeitspraxis von Jona Fels in Freiburg – einladender Sitzbereich mit Sofa, Sessel und warmem Licht";
