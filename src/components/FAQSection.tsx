...
export const FAQSection = () => {
  ...
  return (
    <section className="py-32 md:py-44" aria-labelledby="faq-heading">
      <div className="container mx-auto px-4 max-w-3xl">
        <p className="text-secondary font-medium uppercase tracking-wider text-sm text-center mb-5">
          {language === 'de' ? 'Häufige Fragen' : 'Common Questions'}
        </p>
        <h2 id="faq-heading" className="font-serif text-2xl md:text-3xl lg:text-4xl font-semibold text-foreground text-center mb-20">
          {t("faq.title")}
        </h2>
