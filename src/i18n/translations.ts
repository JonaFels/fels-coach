...
export const translations: Translations = {
  ...
  "about.geschwister.title": {
    de: "Selbsthilfegruppe Geschwister Freiburg",
    en: "Self-Help Group Geschwister Freiburg",
  },
  "about.geschwister.text": {
    de: "Neben meiner Coaching-Praxis habe ich die Selbsthilfegruppe Geschwister Freiburg ins Leben gerufen – einen geschützten Raum für Menschen, die mit herausfordernden Familiendynamiken aufwachsen mussten.",
    en: "Alongside my coaching practice, I founded the self-help group Geschwister Freiburg – a safe space for people who grew up with challenging family dynamics.",
  },
  "about.geschwister.cta": {
    de: "Mehr über Geschwister Freiburg",
    en: "Learn more about Geschwister Freiburg",
  },
