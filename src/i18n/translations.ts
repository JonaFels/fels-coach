...
export const translations: Translations = {
  ...
  "imprint.address": { de: "Systemisches Coaching & Familienaufstellungen", en: "Systemic Coaching & Family Constellations" },
  ...
  "terms.s1.text": { de: "Diese Allgemeinen Geschäftsbedingungen gelten für alle Vereinbarungen und Dienstleistungen zwischen Jona Fels – Systemisches Coaching & Familienaufstellungen (nachfolgend \u201ECoach\u201C) und dir als Klient:in. Sie bilden die vertragliche Grundlage unserer Zusammenarbeit, sofern wir nicht individuell etwas anderes schriftlich vereinbaren.", en: 'These General Terms and Conditions apply to all agreements and services between Jona Fels – Systemic Coaching & Family Constellations (hereinafter "Coach") and you as a client. They form the contractual basis of our collaboration unless we individually agree otherwise in writing.' },
