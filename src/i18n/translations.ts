...
export const translations: Translations = {
  ...
  "offerings.coaching.title": {
    de: "Aufstellungsarbeit mit Einzelaufstellung",
  ...
  "offerings.paket5.desc": {
    de: "Fünf reguläre Aufstellungsarbeitstermine zum Vorteilspreis. Ideal für einen intensiven Prozess mit messbaren Fortschritten.",
  ...
  "offerings.paket10.desc": {
    de: "Zehn reguläre Aufstellungsarbeitstermine für eine umfassende Transformation. Begleitung größerer Entwicklungsprozesse mit tiefgreifender Klarheit.",
  ...
  "imprint.address": { de: "Systemische Aufstellung & Familienaufstellung in Freiburg", en: "Systemic Constellation & Family Constellation in Freiburg" },
  ...
  "imprint.coachingHeading": { de: "Berufsrechtlicher Hinweis zum Aufstellungsarbeit", en: "Legal notice regarding coaching" },
  ...
  "terms.s1.text": { de: "Diese Allgemeinen Gesch\u00e4ftsbedingungen gelten f\u00fcr alle Vereinbarungen und Dienstleistungen zwischen Systemische Aufstellung & Familienaufstellung in Freiburg \u2013 Jona Fels (nachfolgend \u201EAufsteller\u201C) und dir als Klient:in. Sie bilden die vertragliche Grundlage unserer Zusammenarbeit, sofern wir nicht individuell etwas anderes schriftlich vereinbaren.", en: "These General Terms and Conditions apply to all agreements and services between Systemic Constellation & Family Constellation in Freiburg \u2013 Jona Fels (hereinafter \u201CConstellation Facilitator\u201D) and you as a client. They form the contractual basis of our collaboration unless we individually agree otherwise in writing." },
