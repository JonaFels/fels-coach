...
export const translations: Translations = {
  ...
  "terms.s1.text": { de: "Diese Allgemeinen Gesch\u00e4ftsbedingungen gelten f\u00fcr alle Vereinbarungen und Dienstleistungen zwischen Jona Fels \u2013 Systemisches Coaching & Familienaufstellungen (nachfolgend \u201ECoach\u201C) und dir als Klient:in. Sie bilden die vertragliche Grundlage unserer Zusammenarbeit, sofern wir nicht individuell etwas anderes schriftlich vereinbaren.", en: "These General Terms and Conditions apply to all agreements and services between Jona Fels \u2013 Systemisches Coaching & Familienaufstellungen (hereinafter \u201CCoach\u201D) and you as a client. They form the contractual basis of our collaboration unless we individually agree otherwise in writing." }, gelten für alle Vereinbarungen und Dienstleistungen zwischen Jona Fels – Systemisches Coaching & Familienaufstellungen (nachfolgend \u201ECoach\u201C) und dir als Klient:in. Sie bilden die vertragliche Grundlage unserer Zusammenarbeit, sofern wir nicht individuell etwas anderes schriftlich vereinbaren.", en: 'These General Terms and Conditions apply to all agreements and services between Jona Fels – Systemisches Coaching & Familienaufstellungen (hereinafter "Coach") and you as a client. They form the contractual basis of our collaboration unless we individually agree otherwise in writing.' }, { de: "Diese Allgemeinen Geschäftsbedingungen gelten für alle Vereinbarungen und Dienstleistungen zwischen Jona Fels – Systemisches Coaching & Familienaufstellungen (nachfolgend \u201ECoach\u201C) und dir als Klient:in. Sie bilden die vertragliche Grundlage unserer Zusammenarbeit, sofern wir nicht individuell etwas anderes schriftlich vereinbaren.", en: "These General Terms and Conditions apply to all agreements and services between Jona Fels – Systemisches Coaching & Familienaufstellungen (hereinafter \"Coach\") and you as a client. They form the contractual basis of our collaboration unless we individually agree otherwise in writing." }, gelten f00fcr alle Vereinbarungen und Dienstleistungen zwischen Jona Fels 2013 Systemisches Coaching & Familienaufstellungen (nachfolgend 201eCoach201c) und dir als Klient:in. Sie bilden die vertragliche Grundlage unserer Zusammenarbeit, sofern wir nicht individuell etwas anderes schriftlich vereinbaren.", en: "These General Terms and Conditions apply to all agreements and services between Jona Fels 2013 Systemisches Coaching & Familienaufstellungen (hereinafter \"Coach\") and you as a client. They form the contractual basis of our collaboration unless we individually agree otherwise in writing." },
  ...
  "privacy.s7.p1": { de: "Für schnelle Antworten auf häufige Fragen biete ich einen KI-gestützter Chatbot von Chatbase, Inc. (USA) an. Der Chatbot wird erst aktiv, wenn du ihn nutzt. Bitte gib in den Chat keine sensiblen persönlichen Daten (wie z.\u00a0B. gesundheitliche Details) ein. Deine Eingaben werden zur Verarbeitung der Antwort an den Anbieter übermittelt.", en: "For quick answers to common questions, I offer an AI-powered chatbot from Chatbase, Inc. (USA). The chatbot only becomes active when you use it. Please do not enter sensitive personal data (such as health details) into the chat. Your inputs are transmitted to the provider for processing the response." },
  "privacy.s7.p2": { de: "Rechtsgrundlage: Deine Einwilligung durch Nutzung des Chats (Art. 6 Abs. 1 lit. a DSGVO).", en: "Legal basis: Your consent through use of the chat (Art. 6(1)(a) GDPR)." },
  "privacy.s8.heading": { de: "8. Kostenloses E-Book", en: "8. Free E-Book" },
  "privacy.s8.p1": { de: "Wenn du mein kostenloses E-Book anforderst, speichere ich deinen Namen und deine E-Mail-Adresse über die Plattform Lovable (Lovable AB, Schweden) und nutze den Dienst Resend, um dir das E-Book zuzusenden. Die Daten werden ausschließlich für diese Zustellung verwendet. Wenn du keinen weiteren Kontakt wünschst, werden die Daten nach dem Versand gelöscht und nicht für Werbezwecke missbraucht.", en: "If you request my free e-book, I store your name and email address via the Lovable platform (Lovable AB, Sweden) and use the Resend service to send you the e-book. The data is used exclusively for this delivery. If you do not wish further contact, the data will be deleted after sending and will not be used for advertising purposes." },
  "privacy.s8.p2": { de: "Rechtsgrundlage: Vertragserfüllung (Art. 6 Abs. 1 lit. b DSGVO).", en: "Legal basis: Contract performance (Art. 6(1)(b) GDPR)." },
