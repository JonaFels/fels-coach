...
export const translations: Translations = {
  ...
  "privacy.s6.heading": { de: "6. Kontaktaufnahme, Kontaktformular & E-Mail-Versand (Supabase & Resend)", en: "6. Contact, Contact Form & Email Delivery (Supabase & Resend)" },
  "privacy.s6.p1": { de: "Wenn du mich über das Kontaktformular, per E-Mail oder über Telegram kontaktierst, speichere ich deine Angaben (Name, E-Mail-Adresse, Inhalt der Nachricht), um deine Anfrage zu beantworten. Pflichtfelder im Formular sind Name, E-Mail und Nachricht; weitere Angaben sind freiwillig. Deine Eingaben werden bereits im Browser validiert und TLS-verschlüsselt übertragen.", en: "If you contact me via the contact form, by email, or via Telegram, I store your details (name, email address, message content) in order to respond to your enquiry. Required fields in the form are name, email and message; any further information is voluntary. Your inputs are validated in the browser and transmitted via TLS encryption." },
  "privacy.s6.p2": { de: "Technische Verarbeitung: Eine serverseitige Funktion (Edge Function) nimmt deine Anfrage entgegen und speichert sie in einer durch Row-Level-Security geschützten Datenbanktabelle („contacts\"), die auf der Infrastruktur von Supabase, Inc. (970 Toa Payoh North #07-04, Singapur 318992; EU-Region) gehostet wird. Lese­zugriff auf diese Tabelle habe ausschließlich ich als Admin. Anschließend wird über den E-Mail-Dienst Resend (Resend, Inc., 2261 Market Street #5039, San Francisco, CA 94114, USA) eine Benachrichtigungs-E-Mail an mich (jona@fels-coach.de) ausgelöst. Resend verarbeitet dazu deinen Namen, deine E-Mail-Adresse und den Inhalt deiner Nachricht ausschließlich zur Zustellung dieser einen E-Mail. Zum Schutz vor Missbrauch wird zusätzlich deine IP-Adresse kurzfristig in einer Rate-Limit-Tabelle gespeichert (max. 5 Anfragen pro IP / 60 Minuten). Bei der Nutzung von Telegram weise ich darauf hin, dass Daten auf den Servern des Anbieters (ggf. außerhalb der EU) verarbeitet werden.", en: "Technical processing: A server-side function (Edge Function) receives your request and stores it in a database table (\"contacts\") protected by Row-Level Security and hosted on the infrastructure of Supabase, Inc. (970 Toa Payoh North #07-04, Singapore 318992; EU region). Read access to this table is restricted to me as admin. A notification email is then triggered to me (jona@fels-coach.de) via the email service Resend (Resend, Inc., 2261 Market Street #5039, San Francisco, CA 94114, USA). Resend processes your name, email address and message content solely to deliver that single email. To prevent abuse, your IP address is also briefly stored in a rate-limit table (max. 5 requests per IP / 60 minutes). When using Telegram, please note that data may be processed on the provider's servers (potentially outside the EU)." },
