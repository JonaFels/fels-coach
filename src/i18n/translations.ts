...
export const translations: Translations = {
  ...
  // Beratung Description (Homepage) – Pain Point
  "coaching.title": {
  ...
  "coaching.text2": {
    de: "In meiner Beratung schaffst du den Raum, um endlich bei dir selbst anzukommen. Ein sicherer Ort und eine Begleitung, die dir mit Aufrichtigkeit zur Seite steht.",
  ...
  "offerings.paket5.desc": {
    de: "Fünf reguläre Beratungstermine zum Vorteilspreis. Ideal für einen intensiven Prozess mit messbaren Fortschritten.",
  ...
  "offerings.paket10.desc": {
    de: "Zehn reguläre Beratungstermine für eine umfassende Transformation. Begleitung größerer Entwicklungsprozesse mit tiefgreifender Klarheit.",
  ...
  "imprint.address": { de: "Systemische Beratung & Familienaufstellung in Freiburg", en: "Systemic Counseling & Family Constellation in Freiburg" },
  ...
  "imprint.coachingHeading": { de: "Berufsrechtlicher Hinweis zum Beratung", en: "Legal notice regarding coaching" },
  "imprint.coachingText": { de: "Mein Angebot im Rahmen des Systemischen Beratung und der Familienaufstellungen dient der Persönlichkeitsentwicklung, der Gesundheitsprävention und der Lösungsfindung. Es stellt keine Heilbehandlung dar und ist kein Ersatz für eine medizinische, psychiatrische oder psychotherapeutische Diagnose oder Behandlung. Bei gesundheitlichen oder psychischen Beschwerden wende dich bitte an einen Arzt oder Psychotherapeuten.", en: "My services in the area of systemic coaching and family constellations are intended for personal development, health prevention, and finding solutions. They do not constitute medical treatment and are not a substitute for medical, psychiatric, or psychotherapeutic diagnosis or treatment. If you have health or psychological concerns, please consult a doctor or psychotherapist." },
  ...
  "terms.s1.text": { de: "Diese Allgemeinen Gesch\u00e4ftsbedingungen gelten f\u00fcr alle Vereinbarungen und Dienstleistungen zwischen Systemische Beratung & Familienaufstellung in Freiburg \u2013 Jona Fels (nachfolgend \u201EBerater\u201C) und dir als Klient:in. Sie bilden die vertragliche Grundlage unserer Zusammenarbeit, sofern wir nicht individuell etwas anderes schriftlich vereinbaren.", en: "These General Terms and Conditions apply to all agreements and services between Systemic Counseling & Family Constellation in Freiburg \u2013 Jona Fels (hereinafter \u201CCounselor\u201D) and you as a client. They form the contractual basis of our collaboration unless we individually agree otherwise in writing." },
  "terms.s2.heading": { de: "2. Leistungsangebot & Abgrenzung zur Heilkunde", en: "2. Services & Distinction from Medical Practice" },
  "terms.s2.p1": { de: "Ich biete systemische Beratung und Familienaufstellungen an. Dabei geht es darum, dir einen geschützten Raum zu geben, in dem du Klarheit über deine Themen gewinnen kannst – sei es in familiären Zusammenhängen, persönlichen Entscheidungen oder inneren Prozessen.", en: "I offer systemic coaching and family constellations. The aim is to provide you with a safe space where you can gain clarity about your issues – be it in family contexts, personal decisions, or inner processes." },
  "terms.s2.p2": { de: "Meine Beratung dient der Persönlichkeitsentwicklung und Lösungsfindung. Sie ist keine Psychotherapie und ersetzt keine medizinische, ärztliche oder psychiatrische Diagnose und Behandlung. Wenn du dich aktuell in einer psychischen Krise befindest oder in therapeutischer Behandlung bist, sprich mich bitte vor der Buchung offen darauf an. Gemeinsam schauen wir, ob eine Beratung für dich sinnvoll und machbar ist.", en: "My coaching serves personal development and finding solutions. It is not psychotherapy and does not replace medical or psychiatric diagnosis and treatment. If you are currently in a mental health crisis or undergoing therapeutic treatment, please let me know openly before booking. Together we will assess whether coaching is appropriate and feasible for you." },
