...
export const translations: Translations = {
  ...
  "coaching.text2": {
    de: "In meinem Beratung schaffst du den Raum, um endlich bei dir selbst anzukommen. Ein sicherer Ort und eine Begleitung, die dir mit Aufrichtigkeit zur Seite steht.",
  ...
  "terms.s2.p2": { de: "Mein Beratung dient der Persönlichkeitsentwicklung und Lösungsfindung. Es ist keine Psychotherapie und ersetzt keine medizinische, ärztliche oder psychiatrische Diagnose und Behandlung. Wenn du dich aktuell in einer psychischen Krise befindest oder in therapeutischer Behandlung bist, sprich mich bitte vor der Buchung offen darauf an. Gemeinsam schauen wir, ob ein Beratung für dich sinnvoll und machbar ist.", en: "My coaching serves personal development and finding solutions. It is not psychotherapy and does not replace medical or psychiatric diagnosis and treatment. If you are currently in a mental health crisis or undergoing therapeutic treatment, please let me know openly before booking. Together we will assess whether coaching is appropriate and feasible for you." },
